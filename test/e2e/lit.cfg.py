...
config.substitutions.append(('%simulator', path.join(config.my_obj_root, 'bin/simulator')))
config.substitutions.append(('%fc', 'FileCheck-10 --allow-empty --match-full-lines'))
config.substitutions.append(('%gcc', 'riscv32-unknown-elf-gcc -O0 -nostdlib -e main'))
